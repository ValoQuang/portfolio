...
type FileInputRef = LegacyRef<HTMLInputElement> | any;
...
export default function DashProfile() {
  ...
  const filePickerRef = useRef<FileInputRef>(null);
  ...
  const uploadImage = async () => {
    ...
    const uploadTask = uploadBytesResumable(storageRef, imageFile as unknown as  Blob | Uint8Array | ArrayBuffer);
    uploadTask.on(
      'state_changed',
      (snapshot) => {
        const progress =
    ...
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        <input
          ...
          ref={filePickerRef as FileInputRef}
          hidden
        />
        <div
